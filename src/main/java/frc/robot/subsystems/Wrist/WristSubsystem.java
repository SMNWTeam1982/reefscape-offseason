...
public class WristSubsystem extends SubsystemBase {
  ...
  private final RelativeEncoder pivotMotorEncoder =
      pivotMotor.getEncoder(); // Encoder for pivotMotor

  private final ArmFeedforward gravityCompensator =
      new ArmFeedforward(
  ...
  public Rotation2d getWristPosition() {
    double positionDegrees =
        pivotMotorEncoder.getPosition()
                * WristConstants.WRIST_ENCODER_ROTATIONS_TO_DEGREES_MULTIPLIER
