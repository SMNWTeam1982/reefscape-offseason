...
public class ElevatorSubsystem extends SubsystemBase {
  public static class ElevatorConstants {
    public static final double LEVEL_1_TARGET_HEIGHT = 0.61;
    public static final double LEVEL_2_TARGET_HEIGHT = 0.9; // #1.05 # change
    ...
    public static final double ALTITUDE_DERIVATIVE_GAIN = 0;
    ...
    public static final double MOTOR_ROTATIONS_TO_ELEVATOR_HEIGHT_METERS_MULTIPLIER =
        1.24744 / 110.5728;
  }
  ...
  /**
   * this motor will be configured to follow the commands of the lead motor so we dont have to set
   * it
   */
  ...
  public ElevatorSubsystem() {
    ...
    followingMotor.configure(
        ElevatorConstants.LEAD_MOTOR_CONFIG.follow(
            11, true), // set the motor to follow the leader and invert its input
        SparkBase.ResetMode.kResetSafeParameters,
        SparkBase.PersistMode.kPersistParameters);
    ...
    altitudePidController.setSetpoint(
        ElevatorConstants
            .IDLE_TARGET_HEIGHT); // very important this is set before running the pid loop
  ...
  public double getElevatorHeight() {
    return leadEncoder.getPosition()
            * ElevatorConstants.MOTOR_ROTATIONS_TO_ELEVATOR_HEIGHT_METERS_MULTIPLIER
