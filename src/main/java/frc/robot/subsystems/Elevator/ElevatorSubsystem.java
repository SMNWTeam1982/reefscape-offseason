...
public class ElevatorSubsystem extends SubsystemBase {
    public static class ElevatorConstants {
        ...
        public static final double MOTOR_ROTATIONS_TO_ELEVATOR_HEIGHT_METERS_MULTIPLIER = 1.24744 / 110.5728;
    }
    ...
    public ElevatorSubsystem() {
        ...
        altitudePidController.setSetpoint(
                ElevatorConstants.IDLE_TARGET_HEIGHT); // very important this is set before running the pid loop
