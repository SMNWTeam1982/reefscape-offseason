...
public final class ReefNavigation {
  ...
  /**
   * these vectors are translations from a tag with an angle of 0 (such as tag 21), they are shifted
   ...
   */
  public static final Pose2d[] REEF_SCORING_POSES =
      new Pose2d[] {
  ...
  public static Pose2d getRightBranchScoringPose(int tagIDOfFace) {
    ...
    Pose2d rightBranchTarget =
        tagPose.transformBy(new Transform2d(rightBranch, new Rotation2d(Math.PI)));
  ...
  public static Pose2d getLeftBranchScoringPose(int tagIDOfFace) {
    ...
    Pose2d leftBranchTarget =
        tagPose.transformBy(new Transform2d(leftBranch, new Rotation2d(Math.PI)));
