...
public final class AutonomousCommands {
     ...
     */
    public static Command scoreNearestL2(DriveSubsystem drive, ElevatorSubsystem elevator, IntakeSubsystem intake) {
        return navigateToNearestScoringPose(drive)
                .andThen(elevator.moveToTargetHeight(
                ...
                .andThen(elevator.setIdle()); // set the elevator to its idle state, and then the command ends and
